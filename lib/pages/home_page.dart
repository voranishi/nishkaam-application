            ...
            children: <Widget>[
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => ProductDetailsPage(
                                    product: products[i],
                                    allProducts:
                                        products, // Pass the entire list of products
                                  ),
                                ),
                              );
                            },
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child:
                      Text('List of Products', style: TextStyle(fontSize: 16)),
                ),
              ),
            ],
          ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
                  child: Container(
                    height: 250, // Fixed height for each row
                    child: Row(
                      children: [
                        for (int i = 0; i < 3; i++)
                          Expanded(
...
class ProductDetailsPage extends StatelessWidget {
  ...
  ProductDetailsPage({required this.product, required this.allProducts});
